...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/stats') {
      ...
      return json({ audits: count, version: 'real-1.0', engine: 'evidence-based', signals: 167 });
    }

    return env.ASSETS ? env.ASSETS.fetch(request) : new Response('AUDIT-AI real engine — 3webobs.com', { headers: CORS });
  }
};
